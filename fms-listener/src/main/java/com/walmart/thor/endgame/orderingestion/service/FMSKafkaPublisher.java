...
public class FMSKafkaPublisher {
  ...
  @Autowired
  public FMSKafkaPublisher(@Qualifier("fmsKafkaProducer") KafkaTemplate<String,
      String> kafkaTemplate, @Value("${spring.kafka.producer.fms-producer-topic}") String fmsStatusTopic,
